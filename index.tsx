    ...
    <div className="min-h-screen bg-pastel-green-light bg-journal-dots relative font-sans text-stone-700 py-6 px-4 md:py-12 sm:px-6 overflow-x-hidden selection:bg-pastel-green selection:text-white">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          {/* Scattered Aesthetic Floating Illustrations / Stickers (Direct Scrapbook layout decoration) */}
          <div className="absolute inset-0 pointer-events-none select-none overflow-hidden z-25">
            
            {/* Direct Placed Float-Swaying Heart 1 */}
            <motion.div 
              style={{ left: '12%', top: '45%' }}
              className="absolute p-2 bg-rose-50 border border-white/80 shadow-md rounded-xl text-rose-400"
              animate={{ 
                y: [0, -12, 0], 
                rotate: [-8, 8, -8],
                scale: [1, 1.05, 1]
            ...
            {/* Direct Placed Float-Swaying Stethoscope Sticker 2 */}
            <motion.div 
              style={{ right: '8%', top: '15%' }}
              className="absolute p-2.5 bg-emerald-50 border border-white/80 shadow-md rounded-xl text-emerald-500"
              animate={{ 
                y: [0, -15, 0], 
                rotate: [12, -8, 12],
            ...
            {/* Direct Placed Float-Swaying Flower Sticker 3 */}
            <motion.div 
              style={{ right: '48%', top: '5%' }}
              className="absolute p-2 bg-pink-50 border border-white/80 shadow-md rounded-xl text-pink-400"
              animate={{ 
                y: [0, -8, 0], 
                rotate: [0, 25, -25, 0]
              }}
            ...
            {/* Direct Placed Float-Swaying Smile Sticker 4 */}
            <motion.div 
              style={{ left: '38%', bottom: '3%' }}
              className="absolute p-2 bg-yellow-50 border border-white/80 shadow-md rounded-xl text-yellow-500"
              animate={{ 
                y: [0, -10, 0], 
                rotate: [-15, 15, -15],
                scale: [1, 1.08, 1]
            ...
            {/* Direct Placed Float-Swaying Sparkle Sticker 5 */}
            <motion.div 
              style={{ left: '5%', bottom: '15%' }}
              className="absolute p-2 bg-teal-50 border border-white/80 shadow-md rounded-xl text-teal-400"
              animate={{ 
                y: [0, -7, 0], 
                rotate: [20, -10, 20]
              }}
